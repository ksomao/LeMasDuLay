    ...
    return (
        ...
        <div className='Gite row section'>
            <div className='GiteDescription col-xs-12 col-lg-4 offset-lg-2 mt-3 mb-2 text-center text-lg-left'>
                ...
                <p>D’une capacité de 4 personnes, l’espace est divisé en deux étages. Au rez-de-chaussée vous disposerez
                    d’un espace vie composé d’un coin cuisine équipée (micro-onde, machines à laver la vaisselle et le
                    linge, réfrigérateur et une plaque de cuisson à induction) et d’un salon (TV et internet). Au
                    premier, vous trouverez un
